...
# setup vars
caps=${EXTERNAL_VPN^^}
VPN_PRIVATE_KEY="${caps}_VPN_PRIVATE_KEY"
VPN_PEER_PUBLIC_KEY="${caps}_VPN_PEER_PUBLIC_KEY"
VPN_PEER_ENDPOINT="${caps}_VPN_PEER_ENDPOINT"
VPN_ADDRESS="${caps}_VPN_ADDRESS"
VPN_FORWARDED_PORT="${caps}_VPN_FORWARDED_PORT"
